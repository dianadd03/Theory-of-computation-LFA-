...
def solve():
    ...
    while exit==0:
        ...
        if(room=="KITCHEN" and stack[-1]!='!'):
            print(f'Your current state: {room}. You should pick the spoon 🥄 in order to win!(use P). Enter action:')
        else:
            print(f'Your current state: {room}. Use WASD to move')
        ...
        if key == 'w':
            ...
            print("Invalid key. Use W/A/S/D or P.")
            continue
